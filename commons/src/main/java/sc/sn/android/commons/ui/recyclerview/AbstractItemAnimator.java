...
public abstract class AbstractItemAnimator
    ...
    public AbstractItemAnimator(RecyclerView recyclerView){
    ...
    private void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(
                    new VpaListenerAdapter() {

                           @Override
                           public void onAnimationStart(View view) {
                               dispatchChangeStarting(changeInfo.oldHolder,
                                                      true);
                           }
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).alpha(1).setListener(
                    new VpaListenerAdapter() {
